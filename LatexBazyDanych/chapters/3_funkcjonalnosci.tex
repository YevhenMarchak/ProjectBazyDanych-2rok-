...
\section{Premia dla pracowników za obsłużone wysyłki (zrealizowane w interfejsie użytkownika)}
\begin{itemize}
...
\section{Obliczenie stopnia realizacji dostawy (zrealizowane w interfejsie użytkownika)}
\begin{itemize}
...
\section{Ocena produktywności pracowników (zrealizowane w interfejsie użytkownika)}
\begin{itemize}
...
\section{Najczęściej wysyłane produkty (zrealizowane w interfejsie użytkownika)}
\begin{itemize}
